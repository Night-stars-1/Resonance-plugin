...
export default function runtimeRender (e, path, renderData = {}, cfg = {}) {
  ...
  const layoutPath =
    process.cwd() + '/plugins/Resonance-plugin/resources/common/layout/'
  return e.runtime.render('Resonance-plugin', path, renderData, {
    ...cfg,
    beforeRender ({ data }) {
      ...
      return {
        ...
        sys: {
          ...
          createdby: `Created By ${Version.name} & Resonance-plugin`
        },
        Math,
        MathPro,
        JSON,
